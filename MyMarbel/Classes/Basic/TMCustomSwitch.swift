//
//  TMCustomSwitch.swift
//  MyMarbel
//
//  Created by Tmaas on 24/06/16.
...
// MARK: -
// MARK: TMCustomSwitchRoundedLayer

public class TMCustomSwitchRoundedLayer: CALayer {
...
public class TMCustomSwitch: UIControl {
    ...
    private func finishInit() {
        ...
        object_setClass(selectedBackgroundView.layer, TMCustomSwitchRoundedLayer.self)
        ...
        object_setClass(titleMaskView.layer, TMCustomSwitchRoundedLayer.self)
        ...
        // Gestures
        tapGesture = UITapGestureRecognizer(target: self, action: #selector(TMCustomSwitch.tapped(_:)))
        addGestureRecognizer(tapGesture)
        
        panGesture = UIPanGestureRecognizer(target: self, action: #selector(TMCustomSwitch.pan(_:)))
    ...
    override public class func layerClass() -> AnyClass {
        return TMCustomSwitchRoundedLayer.self
    }
...
extension TMCustomSwitch: UIGestureRecognizerDelegate {
