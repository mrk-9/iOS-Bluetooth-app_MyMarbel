//
//  TMCircularProgress.swift
//  MyMarbel
//
//  Created by Tmaas on 17/05/16.
//  Copyright © 2016 MBSolution. All rights reserved.
//

import UIKit

public enum TMCircularProgressGlowMode {
    case Forward, Reverse, Constant, NoGlow
}

@IBDesignable
public class TMCircularProgress: UIView {
    ...
    private var progressLayer: TMCircularProgressViewLayer! {
        get {
            return layer as! TMCircularProgressViewLayer
        }
    }
    ...
    @IBInspectable public var glowMode: TMCircularProgressGlowMode = .Forward {
        didSet {
    ...
    override public class func layerClass() -> AnyClass {
        return TMCircularProgressViewLayer.self
    }
    ...
    public func pauseAnimation() {
        guard let presentationLayer = progressLayer.presentationLayer() as? TMCircularProgressViewLayer else { return }
    ...
    private class TMCircularProgressViewLayer: CALayer {
        ...
        var glowMode: TMCircularProgressGlowMode!
        ...
        private struct GlowConstants {
            ...
            static func glowAmountForAngle(angle: Double, glowAmount: CGFloat, glowMode: TMCircularProgressGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .Forward:
        ...
        override init(layer: AnyObject) {
            ...
            let progressLayer = layer as! TMCircularProgressViewLayer
